...
class LeaveRejected extends StatefulWidget {
  const LeaveRejected({Key? key}) : super(key: key);

  @override
  _LeaveRejectedState createState() => _LeaveRejectedState();
}

class _LeaveRejectedState extends State<LeaveRejected> {
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                displayedLeaves[index].formattedSubmittedTime,
                                style: GoogleFonts.poppins(
                          ...
                          Row(
                              ...
                              children: [
                                ...
                                Row(children: [
                                  ...
                                  Text(
                                    '${displayedLeaves[index].approvedBy}',
                                    style: GoogleFonts.poppins(
                                      color: Color(0xFF101828),
                                      fontSize: 12,
                                      fontWeight: FontWeight.w500,
